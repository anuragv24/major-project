    ...
    <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? "max-md:hidden" : ""}`}>
        <div className="pb-5">
            <div className="flex justify-between items-center">
                <img src={null} alt="logo" className="max-w-40 " />
            ...
            {/* Search Bar */}
            <div className=" bg-[#282142] rounded-full flex item-center gap-2 mt-5 px-4 py-3">
        ...
        {filteredUsers.map((user, index) => (
            <div 
                ...
                <img src={user?.profilePic || assets.avatar_icon} alt="UserPic" className='w-[35px] aspect-square rounded-full' />
